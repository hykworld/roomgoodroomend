...
public class QProductImage extends EntityPathBase<ProductImage> {
    ...
    private static final long serialVersionUID = -1483922100L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QProductImage productImage = new QProductImage("productImage");

    public final StringPath piimgName = createString("piimgName");

    public final NumberPath<Long> pinum = createNumber("pinum", Long.class);

    public final StringPath pipath = createString("pipath");

    public final StringPath piuuid = createString("piuuid");
